#############################################################################
# Makefile for building: wg-applet
# Generated by qmake (3.1) (Qt 5.15.1)
# Project:  wg-applet.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile wg-applet.pro -spec linux-clang CONFIG+=debug
#############################################################################
...
INCPATH       = -I. -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I. -I/usr/lib/qt/mkspecs/linux-clang
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
wg-applet: ui_wgapplet.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: wg-applet.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		wg-applet.pro
	$(QMAKE) -o Makefile wg-applet.pro -spec linux-clang CONFIG+=debug
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	clang++ -pipe -g -std=gnu++1z -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
compiler_uic_make_all: ui_wgapplet.h
compiler_uic_clean:
	-$(DEL_FILE) ui_wgapplet.h
ui_wgapplet.h: wgapplet.ui \
		/usr/bin/uic
	/usr/bin/uic wgapplet.ui -o ui_wgapplet.h
...
main.o: main.cpp wgapplet.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

wgapplet.o: wgapplet.cpp wgapplet.h \
		ui_wgapplet.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/wg-applet/bin || mkdir -p $(INSTALL_ROOT)/opt/wg-applet/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/wg-applet/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/wg-applet/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/wg-applet/bin/ 
