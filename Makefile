...
# Template: app
# Command: /usr/bin/qmake -o Makefile wg-applet.pro -spec linux-clang
#############################################################################
...
Makefile: wg-applet.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		wg-applet.pro
	$(QMAKE) -o Makefile wg-applet.pro -spec linux-clang
...
install_target: first FORCE
	...
	-$(STRIP) $(INSTALL_ROOT)/opt/wg-applet/bin/$(QMAKE_TARGET)
