#############################################################################
# Makefile for building: applet
# Generated by qmake (3.1) (Qt 5.15.1)
# Project:  applet.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile applet.pro -spec linux-clang
#############################################################################
...
INCPATH       = -I. -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-clang
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = applet1.0.0
DISTDIR = /home/pdmurray/Desktop/Workspace/wg-applet/.tmp/applet1.0.0
LINK          = clang++
...
Makefile: applet.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		applet.pro
	$(QMAKE) -o Makefile applet.pro -spec linux-clang
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/tmp/applet/bin || mkdir -p $(INSTALL_ROOT)/tmp/applet/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/tmp/applet/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/tmp/applet/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/tmp/applet/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/tmp/applet/bin/ 
